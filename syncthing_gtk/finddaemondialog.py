...
class FindDaemonDialog(EditorDialog):
    ...
    def __init__(self, app):
        EditorDialog.__init__(self, app, "find-daemon.glade", _("Can't invoke the daemon"))
        self.app = app
        ...
        self["lblMessage"].set_markup(
            ...
            % (
                ...
                _(
                    "If you have Syncthing installed, please, set path to "
        ...
        if IS_XP:
            ...
            self["lblMessage"].set_markup(
                ...
                % (
                    _("Syncthing daemon binary cannot be found."),
                    _("If you have Syncthing installed, please, set path to " "%s below") % (exe,),
                )
            )
    ...
    def cb_btDownload_clicked(self, *a):
        ...
        if suffix is None or tag is None:
            ...
            # Set message
            pd = "%s %s" % (platform.uname()[0], platform.uname()[4])  # OS  # architecture
